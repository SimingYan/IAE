...
if 0:
    sys.path.append('/scratch/cluster/siming/Primitive_Detection/pointnet2_ops_lib')
...
class PointTransformerFPModuleV1(nn.Module):
    ...
    def forward(
        ...
        new_features = self.mlp(known_feats.unsqueeze(-1)).squeeze(-1)
...
class PointTransformerFPModule(nn.Module):
    r"""Propigates the features of one set to another
